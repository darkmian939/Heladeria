...
namespace ApiRestBilling.Services
{
    public class PurchaseOrdersService : IPurchaseOrdersService
    {
        ...
        public async Task<decimal> CheckUnitPrice(OrderItems detalle)
        {
        ...
        public async Task<decimal> CalculateSubtotalOrderItem(OrderItems item)
        {
        ...
        public decimal CalcularTotalOrderItems(List<OrderItems> items)
        {
